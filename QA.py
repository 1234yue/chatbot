...
tf.app.flags.DEFINE_integer("size", 64, "Size of each model layer.")  #265
tf.app.flags.DEFINE_integer("num_layers", 3, "Number of layers in the model.")  #2
...
tf.app.flags.DEFINE_string("data_dir", "/var/repos/chat_bot/data", "Data directory")
tf.app.flags.DEFINE_string("train_dir", "/var/repos/chat_bot/models", "Training directory.")
...
def train():
  ...
  """
  from_dev='/var/repos/chat_bot/data/chat_test_id.in'
  from_train = '/var/repos/chat_bot/data/chat_id.in'
  test.process_data()
...
def decode():
  with tf.Session() as sess:
    ...
    # Load vocabularies.
    en_vocab_path = os.path.join(FLAGS.data_dir,'dic.in')
